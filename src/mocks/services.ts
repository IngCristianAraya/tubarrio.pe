...
export const sampleServices: Record<string, Service[]> = {
  ...
  'comida-rapida': [
    {
      ...
      image: 'https://res.cloudinary.com/do2rpqupm/image/upload/v1760366227/WhatsApp_Image_2025-10-12_at_9.56.16_PM_vfpnbk.jpg',
      images: ['https://res.cloudinary.com/do2rpqupm/image/upload/v1760366227/WhatsApp_Image_2025-10-12_at_9.56.16_PM_vfpnbk.jpg'],
      rating: 4.7,
      reviewCount: 89,
      featured: true,
  ...
  'abarrotes': [
    {
      ...
      image: 'https://res.cloudinary.com/do2rpqupm/image/upload/v1760366181/WhatsApp_Image_2025-10-12_at_8.12.40_PM_lgjsab.jpg',
      images: ['https://res.cloudinary.com/do2rpqupm/image/upload/v1760366181/WhatsApp_Image_2025-10-12_at_8.12.40_PM_lgjsab.jpg'],
      rating: 4.2,
      reviewCount: 64,
      featured: true,
  ...
  'servicios-generales': [
    {
      id: 'gym-1',
      slug: 'servicio-tecnico-galaxia',
      name: 'Servicio Técnico Galaxia',
      description: 'Especialistas en la reparación y mantenimiento de electrodomésticos del hogar.',
      category: 'Servicios Generales',
      categorySlug: 'servicios-generales',
      image: 'https://res.cloudinary.com/do2rpqupm/image/upload/v1760202226/375796981_122095257500041508_8417277859689659654_n_pgmcna.jpg',
      images: ['https://res.cloudinary.com/do2rpqupm/image/upload/v1760202226/375796981_122095257500041508_8417277859689659654_n_pgmcna.jpg'],
      rating: 4.8,
      reviewCount: 156,
      featured: true,
  ...
  'servicios-profesionales': [
    {
        id: 'serv-2',
      slug: 'podologia-anita',
      name: 'Podología Anita',
      description: 'Servicio de podología profesional cuidamos la salud y bienestar de tus pies con atención personalizada y tratamientos especializados.',
      category: 'Servicios Profesionales',
      categorySlug: 'servicios-profesionales',
      image: 'https://res.cloudinary.com/do2rpqupm/image/upload/v1760203544/WhatsApp_Image_2025-10-11_at_12.24.42_PM_cagc44.jpg',
      images: ['https://res.cloudinary.com/do2rpqupm/image/upload/v1760203544/WhatsApp_Image_2025-10-11_at_12.24.42_PM_cagc44.jpg'],
      rating: 4.8,
      reviewCount: 156,
      featured: true,
      tags: ['podología', 'tratamiento', 'salud', 'bienestar', 'personalizada']
    },
    {
      id: 'serv-1',
      slug: 'sannaterapia',
