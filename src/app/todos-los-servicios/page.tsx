...
function TodosLosServiciosPage() {
  ...
  <span className="block mx-auto mt-3 h-2 w-32 md:w-48 rounded-full bg-gradient-to-r from-orange-400 via-yellow-300 to-orange-400 animate-pulse opacity-80"></span>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 -mt-20 relative z-10">

      <div className="flex flex-col gap-4 mb-8 sticky top-4 z-20 bg-white/60 backdrop-blur-sm rounded-xl p-4 shadow-md">
        <input
          type="text"
