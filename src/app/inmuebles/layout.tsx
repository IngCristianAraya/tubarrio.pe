...
export const metadata: Metadata = {
  title: 'Inmuebles en venta y alquiler | TuBarrio.pe',
  description: 'Explora departamentos, casas y locales con fotos, detalles, mapa y contacto directo en TuBarrio.pe.',
  keywords: 'inmuebles, departamentos, casas, venta, alquiler, Lima, mapa, fotos, contacto',
  openGraph: {
    title: 'Inmuebles en venta y alquiler | TuBarrio.pe',
    description: 'Encuentra inmuebles con galería de imágenes, descripción, zona aproximada en mapa y opciones de contacto.',
    type: 'website',
  },
};
