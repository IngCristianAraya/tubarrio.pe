// Fallback data para cuando la DB no esté disponible
...
export const fallbackServices: Service[] = [
  ...
  {
    id: 'carniceria-san-borja',
    slug: 'carniceria-san-borja',
    name: 'Carnicería San Borja',
    description: 'Cortes de carne de calidad y productos frescos.',
    category: 'Carnicería',
  ...
  {
    id: 'servicio-de-prueba',
    slug: 'servicio-de-prueba',
    name: 'Servicio de Prueba',
    description: 'Servicio de demostración con coordenadas para pruebas de mapa.',
    category: 'Demostración',
    categorySlug: 'demo',
    barrio: 'San Miguel',
    address: 'Calle Santa Nicerata 334',
    district: 'San Miguel',
    latitude: -12.0774,
    longitude: -77.0863,
