        ...
        {mode === 'responsive' && (
          <div className="hidden md:flex items-center gap-3 flex-1">
            <select
              ...
              className="w-1/3 h-10 px-3 rounded-lg border border-gray-300 bg-white text-sm leading-none"
            ...
            <div className="flex gap-2">
              <button
                type="button"
                className="h-10 inline-flex items-center rounded-lg bg-black text-white px-4 text-sm"
              ...
              <button
                type="button"
                className="h-10 inline-flex items-center rounded-lg border border-gray-300 px-4 text-sm"
