        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 text-center sm:text-left">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4 justify-center sm:justify-start">
              ...
              <span className="ml-3 text-xl font-bold">TuBarrio.pe</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/todos-los-servicios" className="text-gray-400 hover:text-orange-400 transition-colors duration-200">
                  Categorías
                </Link>
              </li>
              <li>
